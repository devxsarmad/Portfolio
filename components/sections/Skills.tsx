...
import { Code2, Database, Palette, Server, Wrench, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <section id="skills" className="py-20 bg-[#020617]">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Book Spine Effect */}
<div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-8 -translate-x-1/2 bg-gradient-to-r from-[#0F172A] via-[#1E293B] to-[#0F172A] rounded-sm shadow-2xl z-10"></div>
          ...
          {/* Book Pages */}
          {/* Book Pages */}
<div className="relative h-[600px] md:h-[600px]" style={{ perspective: "1000px" }}>
